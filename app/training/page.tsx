...
export const metadata: Metadata = { title: 'Technology Training Programs', description: 'Explore Hashbay training in cybersecurity, data science, Azure, hardware and networking, web development and network security.', ...canonicalMetadata('/training') };
...
export default function TrainingPage() {
  return <><Header /><main id="main">
    ...
    <figure className="training-image-band"><div className="image-window"><Image src="/images/learning-illustration.webp" alt="Laptop, notebook and networking equipment arranged for technical learning." fill preload sizes="100vw" /></div><figcaption className="shell">Concept image. Not a Hashbay classroom.</figcaption></figure>
    <ProgramExplorer />
